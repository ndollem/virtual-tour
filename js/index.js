...
function rotateEuler(euler, result) {
  var heading,
      ...
      matrix = [sh * sb - ch * sa * cb, -ch * ca, ch * sa * sb + sh * cb, ca * cb, -sa, -ca * sb, sh * sa * cb + ch * sb, sh * ca, -sh * sa * sb + ch * cb]; // Includes 90-degree rotation around z axis
...
(function () {
    ...
    var scenes = data.scenes.map(function (data) {
        ...
        data.embedHotspot.forEach(function (hotspot) {
            ...
            embedElement.innerHTML = hotspot.url;
        });

        //scene.hotspotContainer().createHotspot(document.querySelector("#textInfo"), { yaw: 2.3028853122966826, pitch: 0.2212550838703713 });
        ...
        data.infoHotspots.forEach(function (hotspot) {
            ...
            } else element = document.getElementById(hotspot.elementID);
